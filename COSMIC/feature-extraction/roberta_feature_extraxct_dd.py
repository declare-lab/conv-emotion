...
roberta = RobertaModel.from_pretrained(
    'checkpoints/dailydialog/',
    checkpoint_file='checkpoint_best.pt',
    data_name_or_path='dailydialog-bin'
)
roberta.eval()
...
pickle.dump([speakers, labels, roberta1, roberta2, roberta3, roberta4, sentences, train_ids, test_ids, valid_ids], open('dailydialog/dailydialog_features_roberta.pkl', 'wb'))
