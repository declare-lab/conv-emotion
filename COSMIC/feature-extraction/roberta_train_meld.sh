TOTAL_NUM_UPDATES=9364  # 30 epochs through MELD for bsz 32
WARMUP_UPDATES=562      # 6 percent of the number of updates
...
CUDA_VISIBLE_DEVICES=0 python train.py "meld-bin/" \
    --log-format "simple" \
