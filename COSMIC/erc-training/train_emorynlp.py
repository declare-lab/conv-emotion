...
def get_EmoryNLP_loaders(batch_size=32, classify='emotion', num_workers=0, pin_memory=False):
...
if __name__ == '__main__':
    ...
    if args.classify == 'emotion':
        lf = open('logs/cosmic_emory_emotion_logs.txt', 'a')
    elif args.classify == 'sentiment':
        lf = open('logs/cosmic_emory_sentiment_logs.txt', 'a')
    ...
    if args.classify == 'emotion':
        rf = open('results/cosmic_emorynlp_emotion_results.txt', 'a')
    elif args.classify == 'sentiment':
        rf = open('results/cosmic_emorynlp_sentiment_results.txt', 'a')
