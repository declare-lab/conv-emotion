...
class CNNFeatureExtractor(nn.Module):
    ...
    def init_pretrained_embeddings_from_numpy(self, pretrained_word_vectors, is_static):
...
class DailyDialogueModel(nn.Module):
    ...
    def init_pretrained_embeddings(self, pretrained_word_vectors, is_static=False):
        self.cnn_feat_extractor.init_pretrained_embeddings_from_numpy(pretrained_word_vectors, is_static)
